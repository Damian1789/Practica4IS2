...
public class Contenedor {
	...
	/**
	 * Metodo para calcular el espacio sobrante en el contenedor,
	 * introduciento en el contenedor el n�mero m�ximo de paquetes que quepan
         * del tama�o del paquete introducir como par�metro
	 * @param p2, es un objeto de tipo Paquete
